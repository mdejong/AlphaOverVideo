...
#
# ext_ffmpeg_encode_bt709_crf.sh IN.mov OUT.m4v ?CRF? ?PROFILE?
#
...
USAGE="usage : ext_ffmpeg_encode_bt709_crf.sh IN.mov OUT.m4v ?CRF? ?PROFILE?"
...
# Colorspace flags to explicitly set BT.709
#COLORSPACE=""
# Rec.709
COLORSPACE="-color_primaries bt709 -color_trc bt709 -colorspace bt709"
#COLORSPACE="-vf scale=in_color_matrix=bt709:out_color_matrix=bt709 -color_primaries bt709 -color_trc bt709 -colorspace bt709"
# Rec 601
#COLORSPACE="-vf scale=out_color_matrix=bt601 -color_primaries smpte170m -color_trc smpte170m -colorspace smpte170m"

...
#
# ext_ffmpeg_encode_linear_crf.sh IN.mov OUT.m4v ?CRF? ?PROFILE?
#
...
USAGE="usage : ext_ffmpeg_encode_linear_crf.sh IN.mov OUT.m4v ?CRF? ?PROFILE?"
...
COLORSPACE="-color_primaries bt709 -color_trc linear -colorspace bt709"
